...
public class GuestbookController {
	...
	public String addEntry(@RequestParam("name") String name, @RequestParam("text") String text, @RequestParam("colour") String colour) {

		guestbook.save(new GuestbookEntry(name, text, colour));
		return "redirect:/guestbook";
	}
	...
	public String addEntry(@RequestParam("name") String name, @RequestParam("text") String text, @RequestParam("colour") String colour, Model model) {

		model.addAttribute("entry", guestbook.save(new GuestbookEntry(name, text, colour)));
