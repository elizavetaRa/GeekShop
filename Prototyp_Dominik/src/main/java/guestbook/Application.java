...
public class Application {
	...
	void initialize() {
        ...
        guestbook.save(new GuestbookEntry("Hans", "Moin", "#FF0000"));
        guestbook.save(new GuestbookEntry("Peter", "Tag auch", "#00FF00"));
        guestbook.save(new GuestbookEntry("Andre", "Tagchen", "#0000FF"));
        guestbook.save(new GuestbookEntry("Eimer", "voll Wasser.", "#FF00FF"));
	}
}
