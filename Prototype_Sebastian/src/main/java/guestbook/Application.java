...
public class Application {
    ...
    void initialize() {
        ...
        guestbook.save(new GuestbookEntry("H4xx0r", "first!!!", "#F96363"));
        guestbook.save(new GuestbookEntry("Arni", "Hasta la vista, baby", "#608BFF"));
        guestbook.save(new GuestbookEntry("Duke Nukem",
                "It's time to kick ass and chew bubble gum. And I'm all out of gum.", "#6EFF60"));
        guestbook.save(new GuestbookEntry("Gump1337",
                "Mama always said life was like a box of chocolates. You never know what you're gonna get.", "#FFB560"));
    }
}
