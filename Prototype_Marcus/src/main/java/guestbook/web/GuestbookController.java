...
public class GuestbookController {
    ...
    public String addEntry(@RequestParam("name") String name, @RequestParam("text") String text, @RequestParam("text2") String color) {
    ...
    public String addEntry(@RequestParam("name") String name, @RequestParam("text") String text, @RequestParam("text2") String color, Model model) {
