...
public class GuestbookController {
	...
	/**
	 * Creates a new {@link guestbook.web.GuestbookController} using the given {@link Guestbook}. The {@link org.springframework.beans.factory.annotation.Autowired} causes the
	 * Spring container to try to find a Spring bean of type {@link Guestbook} and use it to create an instance of
	 * {@link guestbook.web.GuestbookController}.
	 * 
	 ...
	 * into the {@link org.springframework.ui.Model} that's used to render the view.
	 * 
	 * @return
	 */
	 ...
	 * HTML form via the {@link org.springframework.web.bind.annotation.RequestParam} annotations. The mapping also supports other types than {@link String}, see
	...
	public String addEntry(@RequestParam("name") String name, @RequestParam("text") String text, @RequestParam ("gender") String gender) {

		guestbook.save(new GuestbookEntry(name, text, gender));
		return "redirect:/guestbook";
	}
	...
	public String addEntry(@RequestParam("name") String name, @RequestParam("text") String text, @RequestParam("gender") String gender, Model model) {

		model.addAttribute("entry", guestbook.save(new GuestbookEntry(name, text, gender)));
		model.addAttribute("index", guestbook.count());
		return "guestbook :: entry";
	}

	/**
	 * Deletes a {@link GuestbookEntry}. Note how the path variable used in the {@link org.springframework.web.bind.annotation.RequestMapping} annotation is bound
	 * to the controller method using the {@link org.springframework.web.bind.annotation.PathVariable} annotation.
	 * 
